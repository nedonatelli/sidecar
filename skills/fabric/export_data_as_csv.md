...
description: Finds all mentions of data structures within an input and you output properly formatted CSV data that perfectly represents what's in the input.
source: fabric/export_data_as_csv
---
