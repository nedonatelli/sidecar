...
description: Create a perfect set of questions to ask in order to address the security of the component/system at the fundamental design level.
source: fabric/ask_secure_by_design_questions
---
