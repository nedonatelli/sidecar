---
name: Write Hackerone Report
description: Specializes in writing bug bounty reports that are concise, to-the-point, and easy to reproduce.
source: fabric/write_hackerone_report
---
