...
| `plan.externalized`                                                                                                                                                                               | scaffold | long-horizon ablation            | **keep-gated (v0.119)** — mechanics verified; voluntary adoption 0/8 nudged runs across 3 model families; no lift measurable at eval scale (both arms pass). Next: harness-seeded plans from plan-mode approval    |
