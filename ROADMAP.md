...
| ------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| v0.116  | MCP hardening — lazy tool-schema loading + per-server `alwaysLoad` (cut MCP context on small models) · MCP mutation discipline (preflight read → verify round-trip → draft-on-mismatch) |
