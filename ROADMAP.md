...
| `plan.externalized`                                                                                                                                                                               | scaffold | long-horizon ablation            | **keep-gated (v0.119)** — mechanics verified; voluntary adoption 0/~10 nudged runs across 5 model families; above-floor models pass both arms, the floor model (llama3.2) fails both identically without engaging the plan — headroom exists, adoption is the bottleneck. Next: harness-seeded plans from plan-mode approval |
