...
export const planTools: RegisteredTool[] = [
  {
    definition: {
      ...
      description:
        ...
        'and again each time you finish a step (advance `current`, report `last_result`). The harness re-shows ' +
        'you the plan every turn, so it survives long tasks. Restate ALL steps every call. ' +
