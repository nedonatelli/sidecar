...
| Date       | Change                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| ---------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2026-07-31 | Data-loss defect (v0.122.3): fence-write coercion synthesized a `write_file` from a code fence the model only printed, gated on a verb list that classed `read`/`show`/`check` as action verbs. A read-only request could therefore fabricate a file, or overwrite the file being asked about with the model's paraphrase of it — no confirmation, no existence check. Not a confidentiality or privilege issue, but it destroys user data from an operation the user reasonably believes is read-only, so it is recorded here. Coercion now requires a mutating verb. `SECRET_PATTERNS_VERSION` still 3 (unchanged through 0.122.3).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
