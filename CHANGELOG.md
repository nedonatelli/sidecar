...
- **Suite expanded to 46 agent + 29 prompt cases** — new cases: `delete-file-when-requested`, `version-from-package-json`, and 11 code-quality cases (anti-stub cluster + bug-fix cluster).
