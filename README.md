...
| Feature | Description |
|---|---|
| **80 built-in tools** | File ops, shell, git, web search, database (SQLite/PG/MySQL/DuckDB), screenshot, doc-to-test synthesis, code profiling, LaTeX compilation, MCP task delegation, research assistant, CI failure analysis, and more — [full list](https://nedonatelli.github.io/sidecar/tools) |
