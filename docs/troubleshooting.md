...
- **Tool definitions overwhelm the model** — ~~~~~~~29 tool definitions add ~10K chars. Smaller models may not handle this well. Try a larger model or use chat-only mode
